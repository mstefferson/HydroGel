% ChemDiffMainDirVn
% A bc Dir C bc VN
function [A_rec,C_rec,DidIBreak,SteadyState] = ChemDiffMainMxVn(ParamObj,TimeObj,AnalysisObj)
...
[Lop]    = LopMakerRdMxVn(Nx,dx,ParamObj.Bt,ParamObj.Kon,ParamObj.Koff,ParamObj.DA,ParamObj.DC);
