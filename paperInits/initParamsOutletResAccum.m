...
analysisFlags.PlotMeAccum            = 1;  % Concentration at Outlet vs time
...
paramMaster.kinParam1 = {'konBt', [1e1]};  % vec konBt (time scale)
paramMaster.kinParam2 = {'kA', [1e4 1e5 1e6]};  % vec konBt (time scale)
...
timeMaster.t_rec   = timeMaster.t_tot / 25;  % time interval for recording dynamics
...
% koffVary = {'outletboundary', [0.1 1 10]};
koffVary = {'const'};
